...
const config: Config = {
  ...
  url: 'https://aiworkflows.vercel.app',
  ...
  organizationName: 'incrhst', // Usually your GitHub org/user name.
  projectName: 'aiworkflows', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/incrhst/aiworkflows/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/incrhst/aiworkflows',
          label: 'GitHub',
          position: 'right',
        },
      ],
